...
const S_per_familiar = () => {
  ...
  const reservaParaMi = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://localhost:7257/api/Medico/buscar_idpaciente/${usuario.numeroDocumento}`);
      ...
      if (data) {
        ...
        navigate('/Medico', { state: { cli_codigo } }); 
      } else {
  ...
  const reservaParaFamiliar = async () => {
    ...
    try {
      ...
      const response = await axios.get(`https://localhost:7257/api/Medico/buscar_dependiente/${usuario.numeroDocumento}`);
  ...
  return (
    <div className="reserva-cita-container">
      ...
      <div className="contenedor">
        ...
        <div className="menu">
          <button onClick={reservaParaMi} className="button-main">Reserva para mí</button>
          <button onClick={reservaParaFamiliar} className="button-main">Reserva para familiar</button>
        </div>
